...
def makeffstr_ftm(args,cnxn):
	###init vars###
	silencestr = " -af silenceremove=1:0:-50dB:1:30:-50dB" #removes silence of less than -60dba that lasts longer than 15s
	face = args.f
	ffstr = ''
	hlvstr01 = ''
	dblstr01 = ''
...
def makeffstr_stereo(args,cnxn):
	...
	hlvstr01 = ''
	dblstr01 = ''
	silencestr = " -af silenceremove=1:0:-50dB:1:30:-50dB"
	###END INIT###
	###HALFSPEED###
	hlvface = ''
	sqlstr = "select halving_" + face + " from Audio_Masters where rawCaptureName_" + face + "='" + args.i + "' or Audio_Masters.rawCaptureName_" + face + "='" + args.i + ".wav'"
