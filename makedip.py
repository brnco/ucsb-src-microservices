...
def makeTranscodeList(startObjs, archiveDir):
	a = []
	b = []
	m = []
	u =[]
...
def main():
	...
	if args.tape is True:
		...
		a,b,u,m,startDirs = makeTranscodeList(args.so, archiveDir) #make a dictionary of files to work with
